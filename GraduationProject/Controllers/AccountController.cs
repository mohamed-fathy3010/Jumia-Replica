...
namespace GraduationProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> SellerRegister(SellerRegisterViewModel model, HttpPostedFileBase FrontImage, HttpPostedFileBase BackImage)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.Fname, LastName = model.Lname, PhoneNumber = model.PhoneNo };
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    db.Customers.Add(new Customer() { ID = user.Id });
                    db.Wishlists.Add(new Wishlist() { Id = user.Id });
                    db.SaveChanges();
